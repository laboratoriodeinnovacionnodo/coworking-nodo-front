#!/usr/bin/env bash
# ============================================================================
#  v12-fix-disponibilidad-todas.sh  — coworking-front
#
#  Problema: DisponibilidadInline usaba getActivas() que filtra por
#  fechaHasta >= hoy. Esto excluía:
#    · Ocupaciones cuyo horario ya venció HOY pero no fueron liberadas
#    · Ocupaciones futuras (próximos días) que también necesitan gestión
#
#  Fix: usar getAll() + filtrar liberadaAt === null en cliente.
#  Así aparece TODO lo que está pendiente de liberar, ordenado por fecha.
#
#  Sin cambios de schema. Sin cambios en el backend.
#
#  Uso:
#    cd coworking-front
#    chmod +x v12-fix-disponibilidad-todas.sh
#    ./v12-fix-disponibilidad-todas.sh
# ============================================================================
set -euo pipefail
...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  🔧  v12 — Disponibilidad muestra TODAS las ocupaciones         ║"
echo "╚══════════════════════════════════════════════════════════════════╝"

# ════════════════════════════════════════════════════════════════════════════
# components/disponibilidad-inline.tsx
# ════════════════════════════════════════════════════════════════════════════
...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  ✅  v12-fix-disponibilidad-todas.sh completado                 ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""
echo "  Cambios en disponibilidad-inline.tsx:"
echo "    · Usa getAll() en lugar de getActivas()"
echo "    · Filtra liberadaAt === null en cliente"
echo "    · Muestra TODAS las ocupaciones pendientes: vencidas, en curso y futuras"
echo "    · Orden: en-curso → próximas → vencidas"
echo "    · Badge de estado por ocupación: 'En curso' / 'Próxima' / 'Vencida'"
echo "    · Vencidas con ícono de alerta y aviso para liberar manualmente"
echo "    · Cálculo de estado en hora Argentina (UTC-3 inmutable)"
echo ""
